...
- The first spatial fitted paths are now `spatial(1 | site, coords = coords)`
  ...
  slopes, and zero-inflated spatial effects remain planned.
...
remain behind their own evidence gates.
