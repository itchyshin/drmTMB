...
- Status: first univariate Gaussian phylogenetic location path implemented;
  ...
  intercepts plus matching bivariate q=2 location covariance and constant q=4
  location-scale covariance are fitted. Sparse large-pedigree construction,
  structured slopes, standalone `sigma` relatedness models, predictor-dependent
