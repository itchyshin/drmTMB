...
- **Overdispersed, zero-heavy, truncated, or hurdle counts.** Use
  ...
  also has one local fit-only hurdle gate,
  `bf(count ~ x, sigma ~ 1, hu ~ relmat(1 | id, Q = Q))`.
