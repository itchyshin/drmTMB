...
This site is built from release-candidate version `0.2.0`. The package is
...
If you need the newest development build from `main`, use:
...
and the compiled headers from `RcppEigen` and `TMB`.
