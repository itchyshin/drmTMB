...
- Evidence among implemented model cells: **0 supported**, **28 inference-ready with caveats**, **159 interval-feasible**, **4 legacy fit-supported (no interval permission)**, **77 point-fit recovery**, and **67 diagnostic-only**.
- Location checks among the 187 interval-claiming cells (`location_checked`; tiers claim interval SHAPE only — docs/design/255): **164 passed**, **23 unchecked**, **0 failed**, **0 not applicable**.
