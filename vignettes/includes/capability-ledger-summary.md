...
- Model-surface total: **702 exact model routes**.
- Runtime: **344 implemented**, **10 not implemented**, and **348 rejected by design**.
- Evidence among implemented model cells: **0 supported**, **28 inference-ready with caveats**, **159 interval-feasible**, **4 legacy fit-supported (no interval permission)**, **80 point-fit recovery**, and **67 diagnostic-only**.
