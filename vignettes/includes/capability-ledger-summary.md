...
- Evidence among implemented model cells: **0 supported**, **28 inference-ready with caveats**, **187 interval-feasible**, **4 legacy fit-supported (no interval permission)**, **56 point-fit recovery**, and **60 diagnostic-only**.
