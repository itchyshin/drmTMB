...
```{r simulation-operating-characteristics, fig.width=8.6, fig.height=4.8, fig.alt="Simulation summary plots showing illustrative replicate-level bias clouds with mean and MCSE intervals, plus interval coverage bars with binomial MCSE whiskers, by estimand across Gaussian location-scale, proportion, and count surfaces."}
...
ggplot(sim_rain, aes(bias_replicate, estimand_label)) +
  ...
  labs(
    ...
    subtitle = "Rainclouds show replicate errors; large points and bars are mean bias with 95% MCSE intervals",
    x = NULL,
