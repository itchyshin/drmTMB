...
better description. Read the [structural-dependence
overview](structural-dependence.html) first if you are still choosing among
`animal()`, `phylo()`, `spatial()`, and `relmat()`.
