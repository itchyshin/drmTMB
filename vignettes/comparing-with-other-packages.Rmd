...
on this family is a different cell (`mc-0227`, recorded two tiers lower at
`point_fit_recovery` — the ordered scale places `diagnostic_only` between the
two) and is not what this comparison fits.
