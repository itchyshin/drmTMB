...
| Check convergence and boundary warnings | `check_drm()` | [Errors, warnings, and convergence](convergence.html) |
...
When the two outcomes need different or discrete families, do not force them
onto the Gaussian `rho12` scale. Start with [Joint or staged bivariate
models](bivariate-nongaussian.html), then use [Association between outcome
pairs](cross-family.html) for the reviewed frozen-margin `biv_associate()`
routes and their alpha-scale intervals.
