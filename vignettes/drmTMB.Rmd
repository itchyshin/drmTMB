...
| bounded-response proportion examples | beta, beta-binomial, and zero-one beta fixed effects plus ordinary recovery-grade `mu` random intercepts and independent numeric slopes; zero-one beta handles structural exact boundaries | "Proportions and success rates" |
