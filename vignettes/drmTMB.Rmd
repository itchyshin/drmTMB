...
The parameter names stay consistent across the site. Location describes the
expected response; scale describes residual variability; shape describes
distribution features beyond location and scale; and coscale means residual
correlation such as `rho12` between two responses. A family may expose only a
...
The model guide [What can I fit today?](model-map.html) is the source for exact
family and component support; this introduction deliberately does not repeat
that changing capability ledger. Once this first fit is checked, continue with
