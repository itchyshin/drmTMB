...
| Gaussian meta-analysis with known sampling covariance | implemented/tested; capability tier unregistered, with no interval or coverage claim | "Mean effects and residual heterogeneity in meta-analysis" |
