...
| Do species trait means remain similar after accounting for shared ancestry, or do sites share coordinate-structured deviations? | [Structured dependence](phylogenetic-spatial.html) | `phylo()`, `spatial()` |
...
| phylogenetic Gaussian `mu`, q=2, q=4, and direct-SD covariance slices | implemented first slices | "Structured dependence" |
| coordinate spatial Gaussian `mu` intercept and one numeric slope | implemented first slice | "Structured dependence" |
