...
intercept, one-slope, and q=2 bivariate location-covariance fields. The
articles "What can I fit today?" and
...
fitted in `mu1` and `mu2`. Richer spatial q=4 and predictor-dependent spatial
