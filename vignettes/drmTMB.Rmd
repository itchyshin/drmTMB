...
| Gaussian meta-analysis with known sampling covariance | implemented, source-tested; ledger tier unregistered | "Mean effects and residual heterogeneity in meta-analysis" |
| fixed-effect bivariate Gaussian `rho12` | implemented; interval-feasible, but CI coverage unregistered | "Changing residual coupling with rho12" |
