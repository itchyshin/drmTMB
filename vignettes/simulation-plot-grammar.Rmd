...
```{r bias-rmse-display, fig.width=8.4, fig.height=5.2, fig.alt="Two simulation accuracy plots faceted by simulation surface: an illustrative raincloud-style bias display with pseudo-replicate errors, mean bias points, and MCSE intervals, followed by an aggregate RMSE display with MCSE intervals for four estimands."}
...
ggplot(accuracy_replicates, aes(error, estimand)) +
  ...
  labs(
    ...
    subtitle = "Clouds/dots: pseudo-replicate errors; points/bars: mean bias with 95% MCSE",
