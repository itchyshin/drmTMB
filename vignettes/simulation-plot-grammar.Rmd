...
```{r bias-rmse-display, fig.width=8.2, fig.height=4.4, fig.alt="Two simulation accuracy plots faceted by simulation surface: a raincloud-style bias display with replicate-level errors, mean bias points, and MCSE intervals, followed by an aggregate RMSE display with MCSE intervals for four estimands."}
...
ggplot(accuracy_replicates, aes(error, estimand)) +
  ...
  labs(
    ...
    subtitle = "Facets are surfaces; clouds and faint dots are displayed errors, large points and bars are mean bias and 95% MCSE",
