...
first same-response mean-scale bridge is also implemented, using a shared label
in `mu1` and `sigma1`, or in `mu2` and `sigma2`. Reusing the same label and
...
mean-mean, scale-scale, same-response mean-scale, ordinary q=4, and
