...
`rho12`, and mesh-based spatial terms are still planned:
...
The first fitted `spatial()` path uses coordinates directly for a univariate
Gaussian `mu` random intercept:
...
At most two `mu` slopes remains the advanced path after more recovery evidence.
