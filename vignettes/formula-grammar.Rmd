...
| `animal(1 | id, A = A)` or `animal(1 | id, Ainv = Ainv)` in `mu` | Implemented first slice | Univariate Gaussian `mu` animal-model random intercept from a precomputed additive relatedness or inverse-relatedness matrix. Pedigree construction and slopes remain planned. |
