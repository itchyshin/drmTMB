...
| `y ~ x1 + x2`, `sigma ~ x1`, `family = beta()` | Planned | Strict continuous proportions in `(0, 1)` with public `sigma`; internally `phi = 1 / sigma^2`. |
...
| `y ~ x1 + x2`, `sigma ~ x1`, `family = truncated_nbinom2()` | Planned | Positive-count NB2 model where `mu` and `sigma` describe the untruncated NB2 count component. |
| `y ~ x1 + x2`, `sigma ~ x1`, `hu ~ x2`, `family = truncated_nbinom2()` | Planned | Hurdle NB2 grammar; `hu` is the hurdle-zero probability and nonzero counts come from a zero-truncated count distribution. |
