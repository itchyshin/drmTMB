...
log-`sigma` scale. Other non-Gaussian random-effect requests are still boundary
checks: NB2 `sigma` slopes or structured effects, Student-t `nu` random effects,
zero-inflation or hurdle random effects,
...
The tutorial [Proportions and success rates](proportion-beta-binomial.html)
works through the strict beta route and keeps boundary values separate.
