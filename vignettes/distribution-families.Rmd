...
and ordinary NB2 also have q=1 phylogenetic `mu` intercept routes,
`phylo(1 | species, tree = tree)`, on the log-mean scale. Ordinary NB2 also
...
ordinal mixed models, spatial/animal/`relmat()` structured effects, count
structured slopes, and correlated or labelled count random-slope blocks need
their own likelihood and recovery evidence before they become runnable syntax.
