...
The practical next-family order is `truncated_nbinom2()`, hurdle NB2 via `hu`,
and then univariate ordinal models. COM-Poisson and generalized Poisson remain
valuable, but they should wait until the mean-dispersion contract and
