...
The interval is **not** an interval for bounded `eta`. Keep the reported scale
visible, for example:
...
other family pairs, eta-scale intervals, random effects, incomplete pairs,
weights, offsets, or REML. The first two still have interval-feasible alpha
methods; the others remain outside the current interval surface.
