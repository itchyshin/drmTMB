...
In the saved simulation study with more observations
(`n = 480` or `960`), all 16 settings met the predeclared criteria for bias,
interval availability, standard-error calibration, and 95% coverage; coverage ranged from
0.935 to 0.957. The earlier study with fewer observations (`n = 120` or `240`)
failed the primary coverage criterion in five settings because some intervals were unavailable.
