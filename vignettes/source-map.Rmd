...
- mesh/SPDE spatial fields, bivariate spatial q=4 covariance blocks, spatial
  scale models, multiple spatial slopes, slope correlations, direct spatial SD
  surfaces, and spatial `corpair()` regressions;
- univariate phylogenetic or spatial effects in `sigma`, `nu`, or `rho12`,
  ...
  one-slope, and bivariate q=2 location-covariance paths;
