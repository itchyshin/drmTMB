...
covariance; `meta_known_V(V = V)` is the compatibility alias.
...
- mesh/SPDE spatial fields, standalone spatial scale models, multiple spatial
  slopes, slope correlations, direct spatial SD surfaces, spatial `corpair()`
  regressions, and non-Gaussian spatial effects;
- univariate phylogenetic or spatial effects in `sigma`, `nu`, or `rho12`,
  plus spatial effects outside the first Gaussian coordinate `mu` intercept,
  one-slope, bivariate q=2 location-covariance, and constant q=4
