...
- residual-scale bivariate random slopes, `rho12` random effects, q6 artifact
  routing, and cross-parameter covariance blocks beyond the currently
  implemented ordinary slope-only, ordinary q4 location, ordinary intercept,
  phylogenetic, animal, and `relmat()` random-effect slices;
