...
| Lognormal, Gamma, beta | fixed-effect `mu` and `sigma` or the family-specific scale | ordinary unlabelled `mu` random intercepts | none | scale random effects, random slopes, bounded-response known covariance, zero-one inflation, and structured dependence |
