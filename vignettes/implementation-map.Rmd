...
| `zi`, `hu`, `zoi`, and `coi` | fixed effects only where supported | no random effects | no covariance layer | fixed-effect tests only | Wald fixed effects where implemented |
