...
| non-Gaussian structured scale or shape effects | fixed-effect `sigma`, `nu`, `zi`, or `hu` formulas where the family supports them | structured scale, shape, zero-inflation, and hurdle random effects need family-specific likelihood, extractor, diagnostic, and recovery contracts |
