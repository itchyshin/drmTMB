...
The implemented bounded-response path is fixed-effect and univariate. Use
`beta_binomial()` for counted successes and failures, and use `beta()` for a
single continuous proportion that is strictly between 0 and 1:
