...
class CapabilityLedgerTests(unittest.TestCase):
    ...
    def test_arc1b_s1_cells_are_exact_and_preserve_the_not_implemented_remainder(self):
        ...
        # contains 92 point_fit_recovery cells after the explicit C12 mc-0653,
        ...
        # promotions, the exact C17-C1 mc-0570 promotion, and the exact C17-C2
        # mc-0578 promotion. Future changes require a
