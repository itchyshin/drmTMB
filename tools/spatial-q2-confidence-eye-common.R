...
ce_target_summary <- function(rows, expected_n) {
  ...
  fit_warning <- !is.na(rows$fit_warning) & nzchar(rows$fit_warning)
  profile_warning <- !is.na(rows$profile_warning) & nzchar(rows$profile_warning)
  warning_count <- sum(fit_warning | profile_warning)
