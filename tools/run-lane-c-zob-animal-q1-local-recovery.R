...
valid <- with(attempts, status == "fit_ok" & convergence == 0L & pdHess &
  max_gradient <= .01 & mode_correlation > .45 & !clamp_active & !boundary_hit)
