...
FIRST_FOUR_CONTRACT_DETAIL = {
    "qseries_beta_mu_animal_rejected": {
        ...
        "implementation_requirements": "reuse beta_family() mu likelihood and animal() known-covariance parser shape; do not change formula grammar, public API, sigma random effects, zoi/coi, q2/q4, REML, or AI-REML",
    ...
    "qseries_beta_sigma_animal_rejected": {
        ...
        "implementation_requirements": "reuse beta_family() scale likelihood and animal() known-covariance parser shape only after the scale-side mapping is reviewed; do not change formula grammar, public API, zoi/coi, q2/q4, REML, or AI-REML",
