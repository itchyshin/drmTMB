...
phylo_prior_tmb_data <- function(precision) {
  ...
  c(
    list(
      ...
      X_mi = dummy_matrix,
      mi_n_state = 0L,
      X_mi_state_mu = dummy_matrix,
      mi_quad_nodes = 0,
      mi_quad_weights = 1,
      mi_x_joint = matrix(0, nrow = 1L, ncol = 2L),
      mi_observed_joint = matrix(1L, nrow = 1L, ncol = 2L),
      mi_col_joint = c(0L, 0L),
      X_mi_joint = dummy_matrix,
      trials = numeric(1),
      weights = 1,
      offset_mu = numeric(1),
      ...
      n_zoi_re_terms = 0L,
      zoi_re_index = matrix(0L, nrow = 1L, ncol = 1L),
      zoi_re_value = dummy_matrix,
      zoi_re_term = 0L,
      n_coi_re_terms = 0L,
      coi_re_index = matrix(0L, nrow = 1L, ncol = 1L),
      coi_re_value = dummy_matrix,
      coi_re_term = 0L,
      has_phylo_mu = 0L,
      has_phylo_mu_q2_covariance = 0L,
      phylo_mu_sd_row = 0L,
      ...
      has_mesh_spatial_mu = 0L,
      A_mesh_spatial = dummy_sparse,
      Q_mesh_spatial = dummy_sparse,
      log_det_Q_mesh_spatial = 0,
      penalize_phylo = 0L,
