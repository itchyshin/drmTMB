...
test_that("recovered binding subsets are machine-readable but cannot schedule", {
  ...
  expect_equal(nrow(recovered), 33L)
  expect_setequal(
    recovered$cell_id,
    c("mc-0005", "mc-0007", "mc-0059", "mc-0184", "mc-0185", "mc-0208", "mc-0209", "mc-0212", "mc-0213", "mc-0225", "mc-0251", "mc-0260m", "mc-0270", "mc-0380", "mc-0388", "mc-0402", "mc-0410", "mc-0411", "mc-0412", "mc-0413", "mc-0423", "mc-0429", "mc-0431", "mc-0435", "mc-0438", "mc-0441", "mc-0448", "mc-0452", "mc-0463", "mc-0511", "mc-0538", "mc-0567")
  )
...
test_that("binding inventory retains every Lane-B cell while exposing recovery state", {
  ...
  expect_equal(sum(inventory$binding_status == "partial_exact_binding"), 31L)
  expect_equal(sum(inventory$binding_status == "partial_negative_control_binding"), 2L)
  expect_equal(sum(inventory$binding_status == "needs_exact_binding"), 126L)
