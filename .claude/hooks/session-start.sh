...
# 1. System toolchain: R + compilers, pandoc, and the -dev libraries that the
#    Suggests packages (ggplot2/systemfonts, curl, xml2, ...) link against.
...
echo "drmTMB session-start hook complete: R toolchain and dependencies ready."
