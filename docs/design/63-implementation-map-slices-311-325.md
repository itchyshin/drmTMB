...
| q8 all-endpoint slope | Intercepts and slopes across `mu1`, `mu2`, `sigma1`, and `sigma2` | Design-only, high risk, and now registry-visible as a no-dispatch pre-code gate |
