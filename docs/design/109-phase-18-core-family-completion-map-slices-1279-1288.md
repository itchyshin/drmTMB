...
1. Treat the count first-wave story as closed by Slice C without adding more
   count syntax.
2. Treat the fixed-effect proportion artifact lane for `beta_family()` and
