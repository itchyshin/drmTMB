...
| 7. Code availability | Runnable user examples now live in the structural-dependence article; a dedicated DGP helper and runner still need to be added under `inst/sim/`. |
