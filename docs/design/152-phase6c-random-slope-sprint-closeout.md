...
| #440 | Bivariate Gaussian slope-only evidence gate | Earlier Phase 6c PR | `docs/design/145-phase6c-bivariate-slope-evidence-gate.md` and `biv_gaussian_mu_slope` artifact route | Held from recovery, coverage, power, residual-scale slope, random-`rho12`, and p8/q8 claims; the later q4 location route now has smoke artifact routing, while q6 remains source-tested only |
