...
document that status. It should not return native parameters under public names.
...
the constructor remains absent from the package namespace and that design
notes say planned, not fitted. A safe no-fit scan checks:
