...
into one ordinary count grid. The spatial, animal, and `relmat()` q=1 count
routes now have source-level recovery tests, but they still need their own
operating-characteristic evidence before any formal simulation parity claim.
