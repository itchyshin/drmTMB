...
6. Continue the broader numerical-guard programme beyond the fixed-effect
   ...
   scale-route grids, larger skew-normal guard grids, Student-t calibration,
   additional random-effect and structured correlation guard depth, larger
   scale-side phylogeny grids, and broader interval consequences still need
