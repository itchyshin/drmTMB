...
6. Continue the broader numerical-guard programme beyond the fixed-effect
   ...
   beta support-floor diagnostic, and the ADEMP design in
   ...
   calibration, correlation guards, and broader interval consequences still
   need sensitivity evidence.
