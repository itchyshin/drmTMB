...
6. Continue the broader numerical-guard programme beyond the fixed-effect
   ...
   feasibility diagnostic, the skew-normal tail-floor source and fit-stress
   diagnostics, the beta/zero-one beta support-floor diagnostic, the residual
   `rho12` open-interval
   ...
   larger Student-t profile/bootstrap calibration, additional random-effect and structured
