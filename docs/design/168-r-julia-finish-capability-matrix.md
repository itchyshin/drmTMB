...
6. Continue the broader numerical-guard programme beyond the fixed-effect
   ...
   diagnostic, the q2 `mu`/`sigma` covariance boundary diagnostic, and the
   ADEMP design in
