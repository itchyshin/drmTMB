...
6. Continue the broader numerical-guard programme beyond the fixed-effect
   ...
   scale-side phylogenetic clamp-active diagnostic, and the ADEMP design in
   `docs/design/176-numerical-guard-simulation-audit.md`: bivariate scale
   routes, larger skew-normal guard grids, Student-t calibration, additional
