...
6. Continue the broader numerical-guard programme beyond the fixed-effect
   ...
   q2 correlation-grid diagnostic, the structured q2 boundary diagnostic, and the ADEMP design in
   ...
   calibration, additional random-effect and structured correlation guard depth, and broader
