...
- [x] G15: Retained fixed-effect profile campaign outputs are recomputed without launching another campaign
  CHECK: Rscript --vanilla tools/temporal-ou-gates.R G15 --reverify
  EXPECT: TEMPORAL_OU_G15_PASS
  EVIDENCE: 60 immutable shards from Fir array `58908599` finished `COMPLETED|0:0` for all 180 Slurm records and were checksum-verified on Totoro. At campaign source `e57ed8c10ea7a715e58b4513ae17484d01b049a8`, the retained 3,000 data sets and nine cell-coefficient rows reverified without launching a fit: `TEMPORAL_OU_PROFILE_CAMPAIGN_SUMMARY_PASS`, `TEMPORAL_OU_PROFILE_CAMPAIGN_QUALIFIED`, and `TEMPORAL_OU_G15_PASS`. All predeclared availability, MCSE-bounded coverage, bias, and profile-width SE-analogue criteria qualified. The durable Totoro summary is `temporal-ou-profile-campaign-summary.csv`, SHA-256 `e303d8c3c688baf5ea3655a459d8f8215d8e85326eb6db86aa5dfb353b191cc5`; U1 retains its one unavailable all-attempt interval in a 999/1,000 availability denominator.
