...
Generated: 2026-05-18 23:08:11 MDT
Repository: `/Users/z3437171/Dropbox/Github Local/drmTMB`
Goal: Slice 298 bivariate rho12 ADEMP sheet
...
```text
## codex/slice-298-biv-rho12-ademp
 M NEWS.md
 M ROADMAP.md
...
```text
 NEWS.md                                         |  1 +
 ROADMAP.md                                      |  1 +
 docs/design/41-phase-18-simulation-programme.md |  2 +-
 docs/dev-log/check-log.md                       | 51 +++++++++++++++++++++++++
 inst/sim/README.md                              |  2 +
...
```text
6d8982fa Add ordinal fixed-effect ADEMP sheet
```
...
- `docs/dev-log/after-task/2026-05-18-slice-291-pre-simulation-ledger.md` (2026-05-18 22:27): # After Task: Slice 291 Pre-Simulation Evidence Ledger
