...
Generated: 2026-05-18 22:10:22 MDT
Repository: `/Users/z3437171/Dropbox/Github Local/drmTMB`
Goal: Slice 289 extractor provenance contracts
...
```text
## codex/slice-289-extractor-contracts
 M NEWS.md
 M R/methods.R
 M R/plot-corpairs.R
 M ROADMAP.md
 ...
 M man/corpairs.Rd
 M man/plot_corpairs.Rd
 M tests/testthat/test-corpairs.R
 M tests/testthat/test-plot-corpairs.R
...
```text
 NEWS.md                                           |  5 +-
 R/methods.R                                       | 20 ++++++-
 R/plot-corpairs.R                                 | 36 +++++++++++--
 ROADMAP.md                                        |  2 +-
 docs/design/39-visualization-grammar.md           | 26 ++++++---
 docs/design/46-pre-simulation-readiness-matrix.md |  2 +
 docs/dev-log/check-log.md                         | 64 +++++++++++++++++++++++
 man/corpairs.Rd                                   |  4 +-
 man/plot_corpairs.Rd                              | 14 +++--
 tests/testthat/test-corpairs.R                    |  7 ++-
 tests/testthat/test-plot-corpairs.R               | 11 ++++
 vignettes/model-map.Rmd                           |  2 +-
...
```text
93a4643d Harden mixed family boundary
```
