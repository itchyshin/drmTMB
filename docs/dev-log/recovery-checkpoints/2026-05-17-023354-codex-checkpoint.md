...
Generated: 2026-05-17 02:33:54 MDT
Repository: `/Users/z3437171/Dropbox/Github Local/drmTMB`
Goal: Slice 151 random-effect scale newdata output contract
...
```text
## codex/slice-151-random-scale-newdata-output...origin/main
 M NEWS.md
 M ROADMAP.md
...
```text
 NEWS.md                                            |  1 +
 ROADMAP.md                                         |  4 ++
 docs/design/18-random-effect-scale-models.md       |  5 ++
 docs/dev-log/check-log.md                          | 78 ++++++++++++++++++++++
 tests/testthat/test-gaussian-random-effect-scale.R | 25 +++++++
...
```text
08842e8 test random-scale raw newdata validation (#115)
```
...
- `docs/dev-log/after-task/2026-05-17-slice-144-required-newdata-variables.md` (2026-05-17 00:38): # After Task: Slice 144 required newdata variables
