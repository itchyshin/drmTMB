...
Generated: 2026-05-18 18:27:42 MDT
Repository: `/Users/z3437171/Dropbox/Github Local/drmTMB`
Goal: Slice 266 gallery source map and QA after drafting Slice 265 PR
Suggested next step: Add a figure-gallery source-map table, run rendered gallery/pkgdown checks, and record QA evidence
...
```text
## codex/slice-266-gallery-source-map-qa
```
...
```text
76e12eec Add simulation plot grammar article
```
