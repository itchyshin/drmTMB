...
Generated: 2026-05-18 20:42:17 MDT
Repository: `/Users/z3437171/Dropbox/Github Local/drmTMB`
Goal: Slice 280 meta_V hardening
...
```text
## codex/slice-280-meta-v-hardening
 M NEWS.md
 M R/drmTMB.R
 ...
 M README.md
 M ROADMAP.md
 M docs/design/22-likelihood-weights.md
 M docs/dev-log/check-log.md
 M docs/dev-log/known-limitations.md
 M man/drmTMB.Rd
 M man/meta_vcov_bivariate.Rd
 M man/relmat.Rd
 M tests/testthat/test-meta-known-v.R
...
```text
 NEWS.md                              |  5 +--
 R/drmTMB.R                           | 14 ++++++--
 R/formula-markers.R                  |  2 +-
 R/meta-vcov.R                        | 18 +++++++---
 README.md                            |  4 +--
 ROADMAP.md                           |  2 +-
 docs/design/22-likelihood-weights.md |  5 +--
 docs/dev-log/check-log.md            | 67 ++++++++++++++++++++++++++++++++++++
 docs/dev-log/known-limitations.md    | 16 +++++----
 man/drmTMB.Rd                        |  7 ++--
 man/meta_vcov_bivariate.Rd           |  2 +-
 man/relmat.Rd                        |  2 +-
 tests/testthat/test-meta-known-v.R   | 34 +++++++++++++++++-
...
```text
285b2794 Harden Bergmann report boundary fixes
```
