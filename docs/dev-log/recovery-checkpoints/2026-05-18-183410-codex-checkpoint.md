...
Generated: 2026-05-18 18:34:10 MDT
Repository: `/Users/z3437171/Dropbox/Github Local/drmTMB`
Goal: Slice 267 Florence closeout after drafting Slice 266 PR
Suggested next step: Record helper-vs-recipe decisions and next visualization backlog, then validate docs and logs
...
```text
## codex/slice-267-florence-closeout
```
...
```text
02b5ff19 Add figure gallery source map
```
