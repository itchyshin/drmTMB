...
Generated: 2026-05-18 20:47:17 MDT
Repository: `/Users/z3437171/Dropbox/Github Local/drmTMB`
Goal: Slice 281 structured user surface
...
```text
## codex/slice-281-structured-user-surface
 M NEWS.md
 M ROADMAP.md
...
```text
 ...
 vignettes/phylogenetic-spatial.Rmd | 18 ++++++++++++++
...
```text
6d97959d Harden meta_V known covariance path
```
