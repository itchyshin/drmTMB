...
Generated: 2026-05-18 21:38:41 MDT
Repository: `/Users/z3437171/Dropbox/Github Local/drmTMB`
Goal: Slice 286 continuous-shape design
...
```text
## codex/slice-286-continuous-shape-design
 M NEWS.md
 M ROADMAP.md
...
```text
 NEWS.md                                           |  1 +
 ROADMAP.md                                        |  2 +-
 docs/design/02-family-registry.md                 | 11 +++++
 docs/design/03-likelihoods.md                     | 31 +++++++++++--
 docs/design/46-pre-simulation-readiness-matrix.md |  2 +-
 docs/dev-log/check-log.md                         | 53 +++++++++++++++++++++++
 vignettes/formula-grammar.Rmd                     |  5 +++
 vignettes/robust-student.Rmd                      |  4 +-
...
```text
7c916b1c Harden proportion model evidence
```
