...
Generated: 2026-05-18 21:08:01 MDT
Repository: `/Users/z3437171/Dropbox/Github Local/drmTMB`
Goal: Slice 283 non-Gaussian family map
...
```text
## codex/slice-283-nongaussian-family-map
 M NEWS.md
 M ROADMAP.md
...
```text
 NEWS.md                                           |  1 +
 ROADMAP.md                                        |  2 +-
 docs/design/02-family-registry.md                 | 61 ++++++++++++++++----
 docs/design/21-tutorial-style.md                  |  5 +-
 docs/design/34-validation-debt-register.md        | 31 +++++++++--
 docs/design/46-pre-simulation-readiness-matrix.md |  6 ++
 docs/dev-log/check-log.md                         | 68 +++++++++++++++++++++++
 vignettes/distribution-families.Rmd               |  7 ++-
 vignettes/source-map.Rmd                          |  8 +--
...
```text
a91a73bf Clarify sparse precision boundary
```
