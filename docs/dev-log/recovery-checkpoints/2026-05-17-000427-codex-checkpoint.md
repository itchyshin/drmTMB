...
Generated: 2026-05-17 00:04:27 MDT
Repository: `/Users/z3437171/Dropbox/Github Local/drmTMB`
Goal: Slice 141 emmeans factor-conditioned grid
Suggested next step: commit Slice 141, open PR, monitor CI, and either merge or continue the next narrow emmeans coverage slice
...
```text
## codex/slice-141-emmeans-factor-by-grid...origin/main
 M NEWS.md
 M ROADMAP.md
...
```text
 ...
 tests/testthat/test-emmeans-methods.R        | 37 ++++++++++++++
...
```text
1c3070a cover emmeans interaction grids (#105)
```
