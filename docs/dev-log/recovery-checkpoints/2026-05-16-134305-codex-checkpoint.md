...
Generated: 2026-05-16 13:43:05 MDT
Repository: `/Users/z3437171/Dropbox/Github Local/drmTMB`
Goal: Slice 103 interval provenance columns
...
```text
## codex/slice-103-interval-provenance
 M NEWS.md
...
```text
 NEWS.md                                   |  4 +++
 R/marginal-parameters.R                   | 21 +++++++++++++--
 R/predict-parameters.R                    | 23 +++++++++++++---
 ROADMAP.md                                |  5 ++++
 docs/design/39-visualization-grammar.md   | 14 ++++++----
 man/marginal_parameters.Rd                |  8 +++++-
 man/predict_parameters.Rd                 | 10 +++++--
 tests/testthat/test-marginal-parameters.R | 45 ++++++++++++++++++++++++++++++-
 tests/testthat/test-predict-parameters.R  | 29 +++++++++++++++++---
 vignettes/model-workflow.Rmd              | 11 +++++---
...
```text
b3e21df Show empirical prediction-grid workflow (#66)
```
