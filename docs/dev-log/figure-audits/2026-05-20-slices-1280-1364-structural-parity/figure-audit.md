...
| `correlation-display-1.png` | residual, group, phylo correlation rows | confidence distribution on Fisher-z scale back-transformed | Wald compatibility density and central intervals | not applicable | low | superseded | The later Confidence Eye default keeps the finite region but removes filled points and CI-line overlays. |
