...
| `figure-gallery` | `correlation-display` | `pkgdown-site/articles/figure-gallery_files/figure-html/correlation-display-1.png` | Illustrative `corpairs()`-like correlation rows | Illustrative Wald/profile intervals transformed through a guarded correlation-link scale | Superseded by the 2026-05-22 Confidence Eye repair: the current display uses pale finite regions and hollow estimates without CI-line overlays. |
