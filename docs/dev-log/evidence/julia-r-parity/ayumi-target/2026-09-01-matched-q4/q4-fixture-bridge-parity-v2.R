...
result_line <- sprintf(
  'Q4_FIXTURE_BRIDGE_PARITY_V2 conv_tmb=%s conv_julia=%s ll_delta=%.9g max_coef_delta=%.9g tmb_s=%.3f julia_s=%.3f n_common=%d tmb_conv_msg=%s',
...
cat(result_line, '\n')
writeLines(result_line, '/private/tmp/claude-503/-Users-z3437171-Dropbox-Github-Local-DRM-jl/afd6975e-02e8-4ecd-ae5c-478837cfc231/scratchpad/q4-fixture-v2-result.txt')
