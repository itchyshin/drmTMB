...
basic-working rows, and 37 basic-distribution recovery
rows. The remaining 0 rows stay in post-v1.0 validation or design.
...
| --- | ---: | ---: | --- |
| Practical v1.0 row surface | 104/104 | 100.0% | Exact Gaussian anchors plus additional Gaussian basic-working rows and basic-distribution recovery rows. |
| Gaussian v1.0 core | 67/67 | 100.0% | Gaussian rows inside the exact-anchor or basic-working v1.0 surface. |
| Basic-distribution recovery | 37/37 | 100.0% | Non-Gaussian rows with point-fit recovery evidence only. |
...
| `basic_distribution_recovery` | 37 | Basic-distribution recovery rows for v1.0. | Recovery-only evidence is not interval evidence, coverage evidence, `inference_ready`, `supported`, REML, AI-REML, or broad structured-covariance support. |
