...
102 row-level roles: 8 exact Gaussian
`inference_ready` anchors, 59 additional Gaussian
basic-working rows, and 35 basic-distribution recovery
rows. The remaining 2 rows stay in post-v1.0 validation or design.
...
| --- | ---: | ---: | --- |
| Practical v1.0 row surface | 102/104 | 98.1% | Exact Gaussian anchors plus additional Gaussian basic-working rows and basic-distribution recovery rows. |
...
| Post-v1.0 validation/design | 2/104 | 1.9% | Rows deliberately left outside the v1.0 practical surface. |
