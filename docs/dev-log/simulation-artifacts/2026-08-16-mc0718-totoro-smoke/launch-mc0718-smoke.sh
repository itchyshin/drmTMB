#!/usr/bin/env bash
# mc-0718 Totoro 27-fit smoke launcher.
...
OUT="${DRMTMB_OUT:-$REPO/docs/dev-log/simulation-artifacts/2026-08-16-mc0718-totoro-smoke}"
RUNNER="${DRMTMB_RUNNER:-$OUT/run-mc0718-smoke.R}"
...
echo "[mc0718] HEAD=$GIT_SHA workers=$NWORKERS out=$OUT"
...
echo "[mc0718] rejection matrix"
run_one reject "$OUT/rejection.tsv"

JOBFILE="$OUT/joblist.txt"
{
  printf '%s\t%s\t%s\n' 4 881401 drmtmb_corr
  printf '%s\t%s\t%s\n' 4 881401 drmtmb_iid
  printf '%s\t%s\t%s\n' 4 881401 glmmtmb_corr
  printf '%s\t%s\t%s\n' 4 881402 drmtmb_corr
  printf '%s\t%s\t%s\n' 4 881402 drmtmb_iid
  printf '%s\t%s\t%s\n' 4 881402 glmmtmb_corr
  printf '%s\t%s\t%s\n' 4 881403 drmtmb_corr
  printf '%s\t%s\t%s\n' 4 881403 drmtmb_iid
  printf '%s\t%s\t%s\n' 4 881403 glmmtmb_corr
  printf '%s\t%s\t%s\n' 8 881801 drmtmb_corr
  printf '%s\t%s\t%s\n' 8 881801 drmtmb_iid
  printf '%s\t%s\t%s\n' 8 881801 glmmtmb_corr
  printf '%s\t%s\t%s\n' 8 881802 drmtmb_corr
  printf '%s\t%s\t%s\n' 8 881802 drmtmb_iid
  printf '%s\t%s\t%s\n' 8 881802 glmmtmb_corr
  printf '%s\t%s\t%s\n' 8 881803 drmtmb_corr
  printf '%s\t%s\t%s\n' 8 881803 drmtmb_iid
  printf '%s\t%s\t%s\n' 8 881803 glmmtmb_corr
  printf '%s\t%s\t%s\n' 14 881141 drmtmb_corr
  printf '%s\t%s\t%s\n' 14 881141 drmtmb_iid
  printf '%s\t%s\t%s\n' 14 881141 glmmtmb_corr
  printf '%s\t%s\t%s\n' 14 881142 drmtmb_corr
  printf '%s\t%s\t%s\n' 14 881142 drmtmb_iid
  printf '%s\t%s\t%s\n' 14 881142 glmmtmb_corr
  printf '%s\t%s\t%s\n' 14 881143 drmtmb_corr
  printf '%s\t%s\t%s\n' 14 881143 drmtmb_iid
  printf '%s\t%s\t%s\n' 14 881143 glmmtmb_corr
} > "$JOBFILE"
...
echo "[mc0718] launching $NJOBS fits with GNU parallel -j $NWORKERS"
START_EPOCH=$(date +%s)
...
echo "[mc0718] wrote $NROWS result rows to $OUT/results.tsv"
if (( NROWS != 27 )); then
