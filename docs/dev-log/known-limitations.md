...
- Random effects in scale formulae, random-effect scale models, labelled
  covariance blocks, and all non-Gaussian families are planned but not yet
  implemented.
