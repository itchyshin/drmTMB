# C16 `mc-0594` completion review — animal zero-one-beta `sigma` q1

## Decision

**GO — point-fit recovery only.** `mc-0594` is ordinary-ML
...
- The source-pinned focused oracle receipt is in
  `2026-08-01-lane-c-c16-mc-0594-animal-sigma-oracle-run-4/`; it checks the
  exact Ainv precision, sigma endpoint, full mixture, objective, gradient, and
  latent-SD dependency.
- The final fixture retains four current-source attempts in
  `2026-08-01-lane-c-c16-mc-0594-animal-sigma-local-run-4/`. All pass
...
- `2026-08-01-lane-c-c16-mc-0594-animal-sigma-source-binding.tsv` pins the
...
| Lens | Verdict | Scope |
| --- | --- | --- |
| Noether | GO | Ainv precision, sigma carrier, likelihood, and oracle. |
...
The only supported ledger change is `mc-0594 -> point_fit_recovery`.
