...
- Merge status per PR, stated explicitly: #1126 MERGED ef796e7f9 (N4). #1122 MERGED 5aa488259 (N5/N5b receipts). #1124 MERGED as d3d205486 (2026-09-03T02:23:10Z, CI green on 4aa0c4600 = branch + main merged in + receipt regenerated). #1125 MERGED as 9bc9db99f (2026-09-03T02:06:17Z, CI green on the tarball-safe head 21a6ae022; closes #1115). #1128 MERGED as fa1ebf95b (2026-09-03T01:44:59Z, CI green). The conductor fills these in as CI completes and each lands.
...
- **N10, PR #1136 MERGED: PENDING at the time of writing.** Plain non-phylo random intercept on sigma labelled (`resd` = `g_logsigma`), and the sdpars attribution defect the builder found fixed in the same PR (the SD now lands under `sdpars$sigma`, live-tested against the TMB engine's placement). Two-group mu-and-sigma random-intercept cases are refused by DRM.jl itself before any label check and are documented as its limitation. Ledger leaf-n10 6/7 before merge.
