...
The contract fingerprint hashes an explicit UTF-8 tabular canonical form, rather
than R serialization, so the local R 4.6 authoring runtime and R 4.5 compute
hosts authenticate the same frozen object.
