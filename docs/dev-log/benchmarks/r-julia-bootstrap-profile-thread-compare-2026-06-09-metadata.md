...
- timestamp: 2026-06-09 06:24:48 -0600
...
- output_csv: docs/dev-log/benchmarks/r-julia-bootstrap-profile-thread-compare-2026-06-09.csv

The R native bootstrap/profile rows call public confint(). The Julia bridge
bootstrap row is a benchmark-only R loop over simulated responses and
