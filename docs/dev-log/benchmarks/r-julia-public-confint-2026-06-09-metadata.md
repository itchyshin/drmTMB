...
- current_public_article_source: true
- scope: warm-session public `confint()` timing and endpoint-parity smoke for
  one 1,000-species AVONET/Hackett Gaussian phylogenetic SD target.
- bootstrap_scope: `B = 10` timing smoke only; not coverage, calibration, or
  endpoint-agreement evidence.
- profile_scope: endpoint parity for one admitted target; not a near-boundary
  calibration study.
- timestamp: 2026-06-09 08:28:19 -0600
...
- git_status_short: |
  ...
  ?? docs/dev-log/after-task/2026-06-09-julia-confint-bridge-slice.md
  ?? docs/dev-log/after-task/2026-06-09-julia-sparse-lbfgs-phylo-default.md
  ?? docs/dev-log/after-task/2026-06-09-model-selection-article-n200.md
  ?? docs/dev-log/after-task/2026-06-09-q8-optimizer-budget-pilot.md
  ...
  ?? docs/dev-log/benchmarks/direct-drmjl-avonet-bootstrap-n100-B2-threads-4-2026-06-09.md
...
- seed: 20260609
- r_workers: 1,4
- run_julia_confint: TRUE
- julia_confint_thread_modes: FALSE,TRUE
- JULIA_NUM_THREADS: 4
- run_julia_bridge: FALSE
- run_profile: TRUE
- profile_workers: 1,4
...
- output_csv: docs/dev-log/benchmarks/r-julia-public-confint-2026-06-09.csv
