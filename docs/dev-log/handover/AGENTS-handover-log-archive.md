# AGENTS.md handover log — archive (2026-07-22 .. 2026-08-18)

Rolled out of `AGENTS.md` on **2026-08-30**. These six `▶ Latest — start here` entries are reproduced
**verbatim, byte for byte** — nothing was summarised, shortened, or re-worded. Only the newest entry
(2026-08-19) remains in `AGENTS.md`.

**Why:** `AGENTS.md` is loaded in full by every agent session before any work starts. The log had grown
to **89% of the file** — one entry (2026-08-15) alone was 519 lines describing PR #1039, which merged
on 2026-08-15. Instructions that every session pays for should be instructions, not history. The
underlying handover documents these entries point to already live in this directory.

**One dangling reference, left as-is on purpose.** The 2026-08-16 entry links to
`docs/dev-log/handover/2026-08-16-cursor-handover-mspl-boundary.md`, which does not exist in this
repository (the sibling `2026-08-16-cursor-handover.md` does). It was already broken in `AGENTS.md`
before this move. It is **not** corrected here, because the block below is a verbatim record and
editing it would falsify that guarantee — noted here instead.

Newest first, exactly as they appeared.
