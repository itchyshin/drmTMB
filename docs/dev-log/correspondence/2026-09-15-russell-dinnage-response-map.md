...
- 16 issues are closed with an evidence comment each. 38 are open (the Moderates, Minors and UX items) and we will work through them; if a closing comment misreads your finding, reopen it.
