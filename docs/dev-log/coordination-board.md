...
## Active Lane Split
- **2026-09-16 ~11:15 MDT — Dinnage arc3 (worktree `local-scratch/lanes/drmTMB-dinnage-arc3-cursor`; [`CLAIMS.md`](lanes/dinnage-arc3-cursor/CLAIMS.md), [`LOOP/checkpoint.md`](lanes/dinnage-arc3-cursor/LOOP/checkpoint.md)).** **`main` @ `4806b4839`** (#1375 merge). **Wave B1 — [#1373](https://github.com/itchyshin/drmTMB/pull/1373) MERGED** @ `f822a34da`. **Wave B2 — [#1375](https://github.com/itchyshin/drmTMB/pull/1375) MERGED** @ `4806b4839` (head `af9fc76ff`; D-263 ACCEPT @ `78df3d4d6`). **Tip-identity receipt:** PR **OPEN** on `main` (regen `public-001.json` post-B2; local **FRESH**); merge when `receipt-staleness` green. **Inert C17 recert** @ `14618e6e4` unchanged. **Wave C: HOLD.**
