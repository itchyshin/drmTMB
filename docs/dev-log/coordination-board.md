...
## Active Lane Split
- **2026-09-17 — Dinnage arc3 Wave C HOLD (Cursor/Composer; [#1380](https://github.com/itchyshin/drmTMB/pull/1380) @ `6f46d089`).** **`main` @ `538302d9c`**. **D-263 REJECT** @ tip ([5718384588](https://github.com/itchyshin/drmTMB/pull/1380#issuecomment-5718384588): P1 `NEWS.md` vs removed deprecated `drmTMB::beta()`). CI green on tip ([`35248209220`](https://github.com/itchyshin/drmTMB/actions/runs/35248209220)) — **no merge** until fixer pushes new tip + settled green CI + fresh **D-263 ACCEPT**. Composer fixer restoring alias / aligning tools.
