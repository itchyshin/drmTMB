...
## Active Lane Split
- **2026-09-16 ~13:45 MDT — Dinnage arc3 (worktree `local-scratch/lanes/drmTMB-dinnage-arc3-cursor`; [`CLAIMS.md`](lanes/dinnage-arc3-cursor/CLAIMS.md), [`LOOP/checkpoint.md`](lanes/dinnage-arc3-cursor/LOOP/checkpoint.md)).** **`main` @ `9aeb36664`** ([#1379](https://github.com/itchyshin/drmTMB/pull/1379) merge; B2 shipped @ `4806b4839` / [#1375](https://github.com/itchyshin/drmTMB/pull/1375) — **do not treat pre-merge B2 tips as live**). **Wave B1 — [#1373](https://github.com/itchyshin/drmTMB/pull/1373) MERGED** @ `f822a34da`. **Wave B2 — [#1375](https://github.com/itchyshin/drmTMB/pull/1375) MERGED** @ `4806b4839`. **Hotfix — [#1379](https://github.com/itchyshin/drmTMB/pull/1379) MERGED** @ `9aeb36664` (A-2 gate + C17 + tip-identity + `drm_pkg_path`). **[#1377](https://github.com/itchyshin/drmTMB/pull/1377) / [#1378](https://github.com/itchyshin/drmTMB/pull/1378) CLOSED** (redundant receipts). **`receipt-staleness` SUCCESS** on `main` after #1379 (run `35141460324`). Prefer **Composer**. **Wave C: NEXT** ([#1339](https://github.com/itchyshin/drmTMB/issues/1339), [#1340](https://github.com/itchyshin/drmTMB/issues/1340); [`wave-b-brief.md`](lanes/dinnage-arc3-cursor/LOOP/wave-b-brief.md) § Wave C).
