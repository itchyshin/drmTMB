...
## Active Lane Split
- **2026-09-16 ~13:22 MDT — Dinnage arc3 (worktree `local-scratch/lanes/drmTMB-dinnage-arc3-cursor`; [`CLAIMS.md`](lanes/dinnage-arc3-cursor/CLAIMS.md), [`LOOP/checkpoint.md`](lanes/dinnage-arc3-cursor/LOOP/checkpoint.md)).** **`main` @ `c30a29274`** (coord; B2 @ `4806b4839` / [#1375](https://github.com/itchyshin/drmTMB/pull/1375) **MERGED** — **do not treat `296a1f763` or other pre-merge B2 tips as live**). **Wave B1 — [#1373](https://github.com/itchyshin/drmTMB/pull/1373) MERGED** @ `f822a34da`. **Wave B2 — [#1375](https://github.com/itchyshin/drmTMB/pull/1375) MERGED** @ `4806b4839`. **`main` `receipt-staleness` / R-CMD-check RED** until hotfix. **Hotfix — [#1379](https://github.com/itchyshin/drmTMB/pull/1379) OPEN** @ `59667a423` (A-2 gate + C17 + tip-identity + `drm_pkg_path`): **merge when R-CMD-check settled green.** **Receipt — [#1377](https://github.com/itchyshin/drmTMB/pull/1377) OPEN** may be **redundant after #1379**; **close #1377 after #1379** if receipts on `main`. Prefer **Composer**. **Wave C: HOLD** ([`wave-b-brief.md`](lanes/dinnage-arc3-cursor/LOOP/wave-b-brief.md) § Wave C).
