...
## Active Lane Split
- **2026-09-24 — Claude lane OPENED: R–Julia parity (post D-269 rename, post Dinnage Wave C).** START HERE: [`handover/2026-09-24-claude-handover.md`](handover/2026-09-24-claude-handover.md). **`origin/main` @ `54df129fe`** (includes #1380 Wave C, #1381/#1388 DRModels bridge). Live repo: drmTMB + DRModels clone at `~/Dropbox/Github Local/DRM.jl`. **First OWED slice:** lane bootstrap + re-pin `source-pins.json` and regenerate parity-matrix/scoreboard/join at measured DRModels `origin/main`. **Does NOT own:** reader-doc PRs (#1417–#1419), #1033, CRAN 0.7 submission, GLLVM.jl s9cov/Latte arc. No CRAN.
- **2026-09-17 — Dinnage arc3 Wave C DONE (Cursor/Composer).** **`main` @ `9c2c6a29`** ([#1380](https://github.com/itchyshin/drmTMB/pull/1380) **MERGED**; head `46f2bf523`, D-263 ACCEPT @ `b60beecc9` [5718829248](https://github.com/itchyshin/drmTMB/pull/1380#issuecomment-5718829248)). CI green [`35255223781`](https://github.com/itchyshin/drmTMB/actions/runs/35255223781) on merge tip. Tip-identity receipt refreshed on `main`; **`receipt-staleness` local FRESH**. Issues [#1339](https://github.com/itchyshin/drmTMB/issues/1339), [#1340](https://github.com/itchyshin/drmTMB/issues/1340).
- **2026-09-16 ~14:15 MDT — Dinnage arc3 (worktree `local-scratch/lanes/drmTMB-dinnage-arc3-cursor`; [`CLAIMS.md`](lanes/dinnage-arc3-cursor/CLAIMS.md), [`LOOP/checkpoint.md`](lanes/dinnage-arc3-cursor/LOOP/checkpoint.md)).** **`main` @ `4f9699855`** ([#1377](https://github.com/itchyshin/drmTMB/pull/1377) merge — **empty vs `c8951f435`**; hotfix [#1379](https://github.com/itchyshin/drmTMB/pull/1379) @ `9aeb36664` already carried A-2 + receipts). B2 shipped @ `4806b4839` / [#1375](https://github.com/itchyshin/drmTMB/pull/1375) — **do not treat pre-merge B2 tips as live**. **Wave B1 — [#1373](https://github.com/itchyshin/drmTMB/pull/1373) MERGED** @ `f822a34da`. **Wave B2 — [#1375](https://github.com/itchyshin/drmTMB/pull/1375) MERGED** @ `4806b4839`. **Hotfix — [#1379](https://github.com/itchyshin/drmTMB/pull/1379) MERGED** @ `9aeb36664`. **Receipt — [#1377](https://github.com/itchyshin/drmTMB/pull/1377) MERGED** @ `4f9699855`. **[#1378](https://github.com/itchyshin/drmTMB/pull/1378) CLOSED** (duplicate). **`receipt-staleness` SUCCESS** on `main` @ `4f9699855` (run `35144807139`). Prefer **Composer**. **Wave C:** see entry above.
