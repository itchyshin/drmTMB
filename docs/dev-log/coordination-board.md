...
## Active Lane Split
- **2026-09-16 ~05:50 MDT — Dinnage arc3 merge queue (coordinator worktree `local-scratch/lanes/drmTMB-dinnage-arc3-cursor`; detail [`lanes/dinnage-arc3-cursor/CLAIMS.md`](lanes/dinnage-arc3-cursor/CLAIMS.md), checkpoint [`lanes/dinnage-arc3-cursor/LOOP/checkpoint.md`](lanes/dinnage-arc3-cursor/LOOP/checkpoint.md), Wave B brief [`lanes/dinnage-arc3-cursor/LOOP/wave-b-brief.md`](lanes/dinnage-arc3-cursor/LOOP/wave-b-brief.md)).** **Board tip on `origin/main` @ `2c15ae63e` (A2 [#1369](https://github.com/itchyshin/drmTMB/pull/1369) merged 2026-09-16).** **Live:** #1369 **MERGED**; #1367 #1368 #1370 #1371 **OPEN** — #1367 and #1368 rebased post-#1369; wait fresh CI then merge queue **#1367 → #1368 → #1370 → #1371** (`gh pr merge --merge`). **Wave B code / Wave C: HOLD until #1367 on `main`** (A2 gate satisfied). #1371 docs-only does not unlock Wave B code.
