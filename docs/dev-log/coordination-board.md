...
## Active Lane Split
- **2026-09-16 ~11:12 MDT — Dinnage arc3 (worktree `local-scratch/lanes/drmTMB-b1375-rebase`; [`CLAIMS.md`](lanes/dinnage-arc3-cursor/CLAIMS.md), [`LOOP/checkpoint.md`](lanes/dinnage-arc3-cursor/LOOP/checkpoint.md)).** **`main` @ `4e6c7e00a`** (coord-only; tip-identity **green** @ `e169d7a76`, run `35111843393`). **Wave B1 — [#1373](https://github.com/itchyshin/drmTMB/pull/1373) MERGED** @ `f822a34da`. **Wave B2 — [#1375](https://github.com/itchyshin/drmTMB/pull/1375) OPEN** @ `78df3d4d6` → **main sync merge in flight** (clear PR **DIRTY**). **Inert C17 recert** @ `14618e6e4`; **D-263 re-ACCEPT @ `78df3d4d6`**. **Not MERGE-READY** until post-sync tip: settled green CI + mergeable head; then **`gh pr merge 1375 --merge`** + [#1374](https://github.com/itchyshin/drmTMB/pull/1374)-style tip-identity receipt on `main`. Grace **`pr_merge_when_green.sh`** poller armed. **Wave C: HOLD.**
