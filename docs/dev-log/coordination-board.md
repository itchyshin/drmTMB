...
## Active Lane Split
- **2026-09-17 — Dinnage arc3 Wave C IN PROGRESS (Cursor/Composer; branch `cursor/dinnage-arc3-wave-c`).** **`main` @ `538302d9c`**. Implements [#1339](https://github.com/itchyshin/drmTMB/issues/1339) (`beta_family()` export; unexported deprecated `beta()` alias) and [#1340](https://github.com/itchyshin/drmTMB/issues/1340) (re-export `nlme::fixef`/`ranef`). Prefer **Composer**. Merge after CI green + independent D-263 ACCEPT only.
- **2026-09-16 ~14:15 MDT — Dinnage arc3 (worktree `local-scratch/lanes/drmTMB-dinnage-arc3-cursor`; [`CLAIMS.md`](lanes/dinnage-arc3-cursor/CLAIMS.md), [`LOOP/checkpoint.md`](lanes/dinnage-arc3-cursor/LOOP/checkpoint.md)).** **`main` @ `538302d9c`** (post [#1377](https://github.com/itchyshin/drmTMB/pull/1377) @ `4f9699855`). B2 @ `4806b4839` / [#1375](https://github.com/itchyshin/drmTMB/pull/1375). **Wave B CLOSED.** **Wave C: IN PROGRESS** (see entry above).
