...
## Active Lane Split
- **2026-09-17 — Dinnage arc3 Wave C HOLD (Cursor/Composer; [#1380](https://github.com/itchyshin/drmTMB/pull/1380) @ `2905e44`).** **`main` @ `538302d9c`**. **D-263 ACCEPT** @ tip ([5718488524](https://github.com/itchyshin/drmTMB/pull/1380#issuecomment-5718488524); P3 NEWS `::` vs `:::` non-blocking). CI **RED** on tip — run [`35252129804`](https://github.com/itchyshin/drmTMB/actions/runs/35252129804): **ubuntu-latest (release) shard 3/4** failed `test-env-skip-census.R` (missing `test-dinnage-audit-wave4c.R` runtime-conditional row). **No merge** until census refresh + settled green CI (D-263 ACCEPT stands until tip moves). Composer fixer.
- **2026-09-16 ~14:15 MDT — Dinnage arc3 (worktree `local-scratch/lanes/drmTMB-dinnage-arc3-cursor`; [`CLAIMS.md`](lanes/dinnage-arc3-cursor/CLAIMS.md), [`LOOP/checkpoint.md`](lanes/dinnage-arc3-cursor/LOOP/checkpoint.md)).** **`main` @ `4f9699855`** ([#1377](https://github.com/itchyshin/drmTMB/pull/1377) merge — **empty vs `c8951f435`**; hotfix [#1379](https://github.com/itchyshin/drmTMB/pull/1379) @ `9aeb36664` already carried A-2 + receipts). B2 shipped @ `4806b4839` / [#1375](https://github.com/itchyshin/drmTMB/pull/1375) — **do not treat pre-merge B2 tips as live**. **Wave B1 — [#1373](https://github.com/itchyshin/drmTMB/pull/1373) MERGED** @ `f822a34da`. **Wave B2 — [#1375](https://github.com/itchyshin/drmTMB/pull/1375) MERGED** @ `4806b4839`. **Hotfix — [#1379](https://github.com/itchyshin/drmTMB/pull/1379) MERGED** @ `9aeb36664`. **Receipt — [#1377](https://github.com/itchyshin/drmTMB/pull/1377) MERGED** @ `4f9699855`. **[#1378](https://github.com/itchyshin/drmTMB/pull/1378) CLOSED** (duplicate). **`receipt-staleness` SUCCESS** on `main` @ `4f9699855` (run `35144807139`). Prefer **Composer**. **Wave C: NEXT** ([#1339](https://github.com/itchyshin/drmTMB/issues/1339), [#1340](https://github.com/itchyshin/drmTMB/issues/1340); [`wave-b-brief.md`](lanes/dinnage-arc3-cursor/LOOP/wave-b-brief.md) § Wave C).
