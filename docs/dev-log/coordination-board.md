...
## Active Lane Split
- **2026-09-16 ~06:33 MDT — Dinnage arc3 (worktree `local-scratch/lanes/drmTMB-dinnage-arc3-cursor`; [`CLAIMS.md`](lanes/dinnage-arc3-cursor/CLAIMS.md), [`LOOP/checkpoint.md`](lanes/dinnage-arc3-cursor/LOOP/checkpoint.md)).** **Main `receipt-staleness` was red** (stale `lss-tip-identity/public-001` after #1367/#1371 and coord doc pushes — **not** R-CMD-check). **HOLD** docs-only pushes to `main` until green **after** [#1372](https://github.com/itchyshin/drmTMB/pull/1372) — **#1372 MERGED** @ `dd937ac3`; run `35096373487` **green**; HOLD **lifted**. **Wave B: UNLOCKED** (#1369 @ `2c15ae63e`, #1367 @ `e6ca0dc8e`). **B1** may code on branches; **do not merge `R/` to `main` until #1372 on main** — satisfied. **Wave A tail:** #1368 → #1370 (#1371 merged); Shinichi merge when CI green. **Wave C: HOLD.**
