...
| Evidence revalidation | E0, B2 exit, serial receipt audit, exact four hashes | PASS in isolated frozen snapshot; 24 imported evidence files remain byte-identical |
