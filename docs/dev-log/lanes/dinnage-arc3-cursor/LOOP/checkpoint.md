...
| #1375 | B2 surfaces | OPEN (D-263 ACCEPT; await CI → merge) | `1424f1971` |

## Wave B

**D-263 ACCEPT @ `1424f1971`; await green CI → merge.** [#1375](https://github.com/itchyshin/drmTMB/pull/1375) on `cursor/dinnage-arc3-b2-surfaces-20260916`. Tip shard fixes: **REML IC**, **A-2 explicit `missing=` gating**, **census TSV**. **P2 (optional):** NEWS / `?miss_control` wording. Merge after settled green CI; tip-identity receipt **LAST** on branch. See [`wave-b-brief.md`](wave-b-brief.md) § B2.
