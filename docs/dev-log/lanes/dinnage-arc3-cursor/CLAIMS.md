...
Updated: 2026-09-15 ~20:35 MDT (Cursor; A1 CI-fix tip pushed).
...
- **A1 docs — COMPLETE — PR [#1368](https://github.com/itchyshin/drmTMB/pull/1368)** (`cursor/dinnage-arc3-a1-docs-20260915`), head `c68620405` (DHARMa in **Suggests** + wave1 installed-doc path guards; follows `d9f7f12eb` doc/C17 tip). All ten A1 issues addressed in-branch (docs, `man/`, vignette, `NEWS.md`, focused evidence). **#1344 cross-PR help cleared.** Independent D-263 **ACCEPT** (docs; unchanged). **CI pending** — re-run after this tip (`gh pr checks 1368`). **Next:** settled green CI, then Shinichi merge only.
