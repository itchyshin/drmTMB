...
| --- | --- | --- | --- |
| **0.7 staged candidate preparation → Claude task 1 (lane 1 of 2)** | **AUTHORIZED, NOT READY, HANDOVER ONLY.** `ac363cadb` is the orientation baseline, not the frozen candidate. Stage A may orient the CRAN gate and salvage predecessor instruments. Candidate SHA, DESCRIPTION bump, and definitive tarball wait for the separation disposition. | [`handover/2026-08-09-claude-handover.md`](handover/2026-08-09-claude-handover.md) · [`2026-08-09-0.7-candidate-preparation-staged-ultra-plan.md`](2026-08-09-0.7-candidate-preparation-staged-ultra-plan.md) | This Claude task must create a fresh execution worktree from refreshed `origin/main`, must not edit lane 2, and must wait at Gate H for its merged disposition receipt. Stop before D-43, unsupported `platform-clean`, final `cran-comments.md`, tag, release publication, or CRAN upload. |
