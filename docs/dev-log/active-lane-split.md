...
| --- | --- | --- | --- |
| **R–Julia parity (Claude, 2026-09-24)** | Post–D-269 DRModels bridge on `main`; parity-joint ledger **17 supported / 6 partial / 13 experimental / 1 unsupported**; `source-pins.json` and generated parity docs still cite 2026-09-05 DRM.jl pin — **OWED** refresh. | START HERE: [`handover/2026-09-24-claude-handover.md`](handover/2026-09-24-claude-handover.md) · plan-actual [`2026-09-05-parity-joint.md`](plan-actual/2026-09-05-parity-joint.md) | **Owns:** `inst/extdata/julia-*.tsv`, `tools/write-parity-*.R`, generated `docs/design/parity-*.md`, bridge receipts under `docs/dev-log/evidence/julia-r-parity/`, `R/julia-bridge.R` when parity-assigned. **Does not own:** reader rewrites (#1417–#1419), Dinnage audit (closed), #1033, `_julia_skip2_artifacts/`, CRAN 0.7 lane. Env: `DRM_JL_PATH` → DRModels repo root. |
