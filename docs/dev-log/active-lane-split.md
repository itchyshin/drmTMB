...
| --- | --- | --- | --- |
| **Phylogenetic OU evidence (new Codex lane)** | `phylo(1 | species, tree = tree, model = "ou")` is implemented as a univariate Gaussian ML location-side covariance option with a positive evolutionary decay point estimate. The frozen panel found weak global-intercept versus tree-field separation, so it has no point-recovery, interval, or coverage claim. | [`handover/2026-09-12-codex-handover.md`](handover/2026-09-12-codex-handover.md), [`after-task/2026-09-11-phylogenetic-ou-covariance.md`](after-task/2026-09-11-phylogenetic-ou-covariance.md), and its PO ledger. | Begin with evidence and scientific-use-case orientation; do not reimplement the provider. Tree OU is distinct from temporal OU, spatial kernels, and the paired phylogeny-plus-time model. P4 heterogeneous Toeplitz and P5 seasonal/ARMA/temporal-Matérn are protected deferred temporal work. |
| **Temporal covariance programme P1--P3** | AR1/OU, homogeneous Toeplitz, and heterogeneous AR1 are closed at their earned scope. P1 and P3 are interval-feasibility only; P2 is closed. | [`after-phase/2026-09-11-temporal-covariance-programme-checkpoint.md`](after-phase/2026-09-11-temporal-covariance-programme-checkpoint.md) at `475b5e065`. | Do not reopen frozen campaign denominators or promote coverage claims. P4/P5 require a fresh ecological use case and child receipt before source edits. |
