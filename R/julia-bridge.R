...
drm_julia_capability_comparison <- function() {
  data.frame(
    ...
    syntax = c(
      ...
      "Gamma()/beta_family()/stats::binomial() with phylo(1 | group, tree = tree)",
      ...
      "bf(y ~ x, sigma ~ 1), family = beta_family(), engine = \"julia\"",
