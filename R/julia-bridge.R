...
drm_julia_intentional_gates <- function() {
  data.frame(
    ...
    drmjl_status = c(
      ...
      "dispersionless axis",
      "Gaussian phylo(1 + x | g) is FIT by DRM.jl since its #620; every other family and marker is still refused there (DRM.jl#621), so the Gaussian refusal is drmTMB's own",
