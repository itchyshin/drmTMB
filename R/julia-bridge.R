...
drm_julia_capability_comparison <- function() {
  data.frame(
    ...
    next_action = c(
      ...
      "Live bridge q4 REML round-trip + recovery pilot banked (defended partial; covered is structurally impossible). Before further promotion: a full (>=200-rep) recovery calibration, profile/bootstrap among-axis SD-interval CIs through the bridge, and bridge==direct numeric faithfulness parity. No release/CRAN language.",
