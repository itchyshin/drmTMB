...
#' slices support `poisson()`, `binomial()`, `nbinom2()`, `beta()`, and
#' `Gamma(link = "log")` responses, each with one fixed-effect Bernoulli/logit
...
#' beta, and Gamma responses are currently supported for one binary missing
#' predictor.
#'
