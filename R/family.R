...
#' formulas for response mean `mu`, response standard deviation `sigma`, and
#' residual slant or shape `nu`.
#'
#' The implemented first slice is fixed-effect and univariate:
