phase18_write_relmat_mu_slope_grid_outputs <- function(
  output_dir,
  ...
  paths <- phase18_simple_grid_paths(
    dirs$table_dir,
    prefix = "relmat-mu-slope"
  )
  phase18_assert_simple_grid_overwrite(
    paths,
    overwrite,
    "Relmat mu slope grid"
  )

  summary <- phase18_summarise_relmat_mu_slope_smoke(
