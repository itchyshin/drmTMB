phase18_dgp_truncated_nbinom2_mu_ri_cell <- function(
  cell,
  seed,
  cell_id,
  replicate
...
phase18_fit_truncated_nbinom2_mu_ri <- function(data, cell) {
  phase18_assert_one_row_data_frame(cell, "cell")
  drmTMB(
...
phase18_run_truncated_nbinom2_mu_ri_smoke <- function(
  ...
  results <- phase18_run_replicates(
    ...
    dgp_fun = phase18_dgp_truncated_nbinom2_mu_ri_cell,
    fit_fun = phase18_fit_truncated_nbinom2_mu_ri,
    summarise_fun = phase18_summarise_truncated_nbinom2_mu_ri_fit,
