phase18_write_biv_gaussian_q2_scale_grid_outputs <- function(
  output_dir,
  ...
  paths <- phase18_simple_grid_paths(
    dirs$table_dir,
    prefix = "biv-gaussian-q2-scale"
  )
  phase18_assert_simple_grid_overwrite(
    paths,
    overwrite,
    "Bivariate Gaussian q2 scale grid"
  )

  summary <- phase18_summarise_biv_gaussian_q2_scale_smoke(
