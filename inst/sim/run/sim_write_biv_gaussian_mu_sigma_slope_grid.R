phase18_write_biv_gaussian_mu_sigma_slope_grid_outputs <- function(
  output_dir,
  ...
  paths <- phase18_simple_grid_paths(
    dirs$table_dir,
    prefix = "biv-gaussian-mu-sigma-slope"
  )
  phase18_assert_simple_grid_overwrite(
    paths,
    overwrite,
    "Bivariate Gaussian mu/sigma slope grid"
  )

  summary <- phase18_summarise_biv_gaussian_mu_sigma_slope_smoke(
