phase18_write_biv_gaussian_q8_endpoint_grid_outputs <- function(
  output_dir,
  ...
  paths <- phase18_simple_grid_paths(
    dirs$table_dir,
    prefix = "biv-gaussian-q8-endpoint"
  )
  phase18_assert_simple_grid_overwrite(
    paths,
    overwrite,
    "Bivariate Gaussian q8 endpoint grid"
  )
