phase18_write_biv_gaussian_q6_location_grid_outputs <- function(
  output_dir,
  ...
  paths <- phase18_simple_grid_paths(
    dirs$table_dir,
    prefix = "biv-gaussian-q6-location"
  )
  phase18_assert_simple_grid_overwrite(
    paths,
    overwrite,
    "Bivariate Gaussian q6 location grid"
  )

  summary <- phase18_summarise_biv_gaussian_q6_location_smoke(
