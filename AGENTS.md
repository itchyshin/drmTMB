...
> | **B — `sd()` SCALE & INTERVALS** | `sd(group) ~ x`, scale clamps, profile endpoints, RE coverage, and exact-binding source recovery | [`2026-07-28-codex-lane-b-e4-handover.md`](docs/dev-log/handover/2026-07-28-codex-lane-b-e4-handover.md) |
>
...
>
> **Lane B snapshot (2026-07-28):** E3/E4 source recovery is documentation-only and
> pushed on `codex/lane-b-e1-exact-binding-recovery`: 76 structured E2 source receipts
> remain non-bindings; E1's eight count-q1 cards remain pending review. E0 stays
> **158 / 62 / 2 / 97** with `pregrid_authorized = FALSE`. **START HERE:**
> [`2026-07-28-codex-lane-b-e4-handover.md`](docs/dev-log/handover/2026-07-28-codex-lane-b-e4-handover.md).
> Do not run DRAC/Totoro, profiles/smokes, canonical binding edits, or make a public/capability
> claim without a later explicit approval. The 364-cell interval-feasibility programme is a
> future multi-lane roadmap, not authority for this Lane-B execution.
>
